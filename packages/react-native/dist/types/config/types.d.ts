 ...
 */
export type ReactNativeSessionTrackingConfig = Omit<NonNullable<Config['sessionTracking']>, 'samplingRate' | 'sampler'> & {
    /**
 ...
 */
export type ReactNativeConfig = Partial<Omit<Config, 'sessionTracking' | 'consoleInstrumentation' | 'userActionsInstrumentation'>> & ReactNativeConfigOverrides;
/**
