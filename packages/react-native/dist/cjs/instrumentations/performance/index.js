...
var PerformanceInstrumentation = /** @class */ (function (_super) {
    ...
    function PerformanceInstrumentation(options) {
        if (options === void 0) { options = {}; }
        var _a, _b, _c;
        var _this = _super.call(this) || this;
        _this.name = '@grafana/faro-react-native:instrumentation-performance';
    ...
    PerformanceInstrumentation.prototype.startPeriodicCollection = function () {
        var _this = this;
        ...
        this.logInfo("Performance monitoring started - collecting every ".concat(this.options.fetchVitalsInterval, "ms ") +
            "(memory: ".concat(this.options.memoryUsageVitals, ", cpu: ").concat(this.options.cpuUsageVitals, ")"));
    };
    PerformanceInstrumentation.prototype.collectMetrics = function () {
    ...
    PerformanceInstrumentation.prototype.collectMemoryUsage = function () {
        try {
            ...
            var memoryUsage = FaroReactNativeModule.getMemoryUsage();
            if (memoryUsage == null || memoryUsage <= 0) {
                this.logDebug('Memory: skipping - value is null or <= 0');
                return;
            }
            this.logDebug("Memory: pushing measurement with mem_usage = ".concat(memoryUsage));
    ...
    PerformanceInstrumentation.prototype.collectCpuUsage = function () {
        try {
            ...
            var cpuUsage = FaroReactNativeModule.getCpuUsage();
            this.logDebug("CPU: raw value = ".concat(cpuUsage));
            ...
            this.logDebug("CPU: pushing measurement with cpu_usage = ".concat(cpuUsage));
    ...
    PerformanceInstrumentation.prototype.unpatch = function () {
        if (this.intervalId) {
