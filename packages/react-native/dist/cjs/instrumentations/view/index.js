...
var ViewInstrumentation = /** @class */ (function (_super) {
    ...
    function ViewInstrumentation() {
        ...
        _this.name = '@grafana/faro-react-native:instrumentation-view';
    ...
    ViewInstrumentation.prototype.initialize = function () {
        var unsubscribe = this.metas.addListener(this.sendViewChangedEvent.bind(this));
     ...
     */
    ViewInstrumentation.prototype.unpatch = function () {
